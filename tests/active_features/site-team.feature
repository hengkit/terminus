Feature: Managing a site's team
  ...
  Scenario: Adding a team member
    When I run "terminus site:team:add [[test_site_name]] --member=[[other_user]] --role=team_member"
  ...
  Scenario: Changing a team member's role
    When I run "terminus site:team:role [[test_site_name]] --member=[[other_user]] --role=admin"
  ...
  Scenario: Removing a team member
    When I run "terminus site:team:remove [[test_site_name]] --member=[[other_user]]"
    Then I should get:
    """
